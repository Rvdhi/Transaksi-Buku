...
<div class="container-fluid" style="text-align: center;">
	...
	<?php } else {
		...
		else
		{
			...
			if($jumlah_data = '1')
			{
				echo "<h1>PEMINJAMAN BUKU<br><strong>$judul</strong></h1>";
				mysqli_query($konek, "insert into transaksi(nokartu, isbn, tanggal_pinjam)values('$nokartu', '$isbn', '$tanggal')");
			} else {
				
				echo "<h1>MENGEMBALIKAN<br><strong>$judul</strong></h1>";
				mysqli_query($konek, "insert into transaksi(tanggal_kembali)values('$tanggal')");
			}
		}
